            ...
            <div x-show="$wire.showModal" x-transition.scale.origin.center
                ...
                <div class="bg-white dark:bg-bg-dark-primary px-6 pt-6 pb-4 relative">
                    ...
                    <h3 class="text-lg font-semibold leading-6 text-gray-900 dark:text-text-dark-primary">
                        {{ $isEditMode ? 'Edit Data Pemberi Zakat' : 'Tambah Data Pemberi Zakat' }}
                    </h3>
                </div>
                ...
                <form wire:submit.prevent='save'>
                    <div class="px-6 py-4 font-normal text-sm">
                        <div class="w-full mb-2">
                                ...
                                <div class="w-full h-fit flex space-x-2 items-center p-3 bg-emerald-700 rounded-md">
                                    <div class="w-[80%]">
                                        ...
                                        <p class="text-base text-gray-50 font-semibold capitalize">
                                            {{ $selectedPemberi['nama'] }}
                                        </p>
                                        <p class="text-sm text-gray-100 font-semibold uppercase">
                                            {{ $selectedPemberi['alamat'] }}
                                        </p>
                                    </div>
                                    <div class="w-[20%] flex justify-end">
                                        <button type="button" wire:click='deselectPemberi'
                            ...
                            @else
                                <label for="searchPemberi" class="text-sm text-gray-900 font-semibold">
                                    Nama
                                </label>
                                <div class="relative w-full">
                                    <input id="searchPemberi" wire:model.live.debounce.300ms='searchPemberi'
                                        ...
                                        <ul
                                            ...
                                            @forelse ($pemberi as $item)
                                                <li class="p-3 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none cursor-pointer"
                                                    ...
                                                    x-on:keydown.enter.prevent="$wire.selectPemberi({{ $item['id'] }})"
                                                    wire:click='selectPemberi({{ $item['id'] }})'>
                                            ...
                                            @empty
                                                <li
                                                    ...
                                                    <p class="text-sm text-gray-800">
                                                        Nama tidak ditemukan. <a href="{{ route('pemberi.index') }}"
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500 dark:text-gray-300">Apakah anda yakin akan
                                        menghapus data pemberi zakat atas nama <span
                                            class="font-semibold capitalize">{{ $deleteData['pemberi']['nama'] ?? '' }}</span>?
                                    </p>
